...
export default function TMHLogoLiquid({ size = 48, className, title = 'Tech My House' }: Props) {
  ...
  return (
    ...
    >
      ...
      <circle cx="60" cy="60" r="55" fill="none" stroke="currentColor" strokeWidth="0.5" opacity="0.35" strokeDasharray="1 3" />
      ...
      <text fontFamily="'Space Grotesk', system-ui, sans-serif" fontWeight="700" fontSize="6.2" letterSpacing="2.6" fill="currentColor" opacity="0.78">
        <textPath href={`#${arcTopId}`} startOffset="50%" textAnchor="middle">
          TECH MY HOUSE
        </textPath>
      </text>

      <text fontFamily="'Space Grotesk', system-ui, sans-serif" fontWeight="700" fontSize="5" letterSpacing="3.4" fill="currentColor" opacity="0.55">
